--CREATE DATABASE AirPandemicOps
...
INSERT INTO Address Values
	...
	(143,'Rajiv Gandhi Cricket Stadium','Hyderabad','TamilNadu','500039','IND'),
	(144,'Vinoo Mankad Rd, Churchgate','Mumbai','Maharashtra','400020','IND'),
	(145,'Feroze Shah Kotla, Raj Ghat', 'New Delhi', 'Delhi', '110002','IND'),
	(146,'Shunyi District','Beijing','Hong Kong','100600','CHI'),
	(147,'1 Sky Plaza Rd,Chek Lap Kok','Hong Kong','Beijing','3P118','CHI'),
	(148,'ul. Leninskiye','Gory','Moscow','119991','RUS'),
	(149,'Pulkovskoye','Shosse','St Petersburg','196140','RUS'),
	(150,'3-12 Ave Street','Denver','Coloardo','80014','USA'),
	(151,'36 Street','Cape','Western Cape','80014','SA'),
	(152,'Burj khalifa','Dubai','Dubai','118','UAE');
...
INSERT INTO iata VALUES
	...
	('HYD','Rajiv Gandhi International Airport' ,'IND'),
	('BOM','Chatrapati Shivaji International Airport','IND'),
	('DEL','Indira Gandhi International Airport','IND'),
	('PVG','Shanghai Airport','CHI'),
	('PEK','Beijing International Airport','CHI'),
	('DME','Domodedovo Moscow Airport','RUS'),
	('LED','Pulkovo Airport','RUS'),
	('GCJ','Grand Central Airport','SA'),
	('BGF','Bangui M"Poko International Airport','CF'),
...
INSERT INTO QurantineCenter VALUES
	...
	('HYD','Shiva',143,'7656453219',25),
	('BOM','Rohit',144,'7656453219',76),
	('DEL','Rishab',145,'7656453219',19),
	('PVG','Jing',146,'9877668909',90),
	('PEK','Yang',147,'7766990098',110),
	('DME','Putin',148,'126990098',65),
	('LED','Kureshi',149,'546994098',54),
	('DEN','Mike', 150, '6754673687',30),
	('GCJ','Ngidi',151,'34094098',50),
	('DXB','Rabada',152,'45694098',94);
